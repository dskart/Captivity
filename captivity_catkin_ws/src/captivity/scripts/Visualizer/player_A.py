...
class PlayerA(PlayerAbstract):
    ...
    def _InitSubscribers(self):
        ...
        rospy.Subscriber("front_door_A_light", UInt8, self._FrontLightCallBack)
        rospy.Subscriber("iris_A_state", UInt8, self._IrisStateCallBack)
        rospy.Subscriber("front_door_A_state", UInt8, self._FrontDoorCallBack)
